...
namespace xingchen\tp6curd\command;

use xingchen\tp6curd\strategy\AutoMakeStrategy;
use xingchen\tp6curd\template\impl\ControllerAutoMake;
use xingchen\tp6curd\template\impl\ModelAutoMake;
use xingchen\tp6curd\template\impl\ValidateAutoMake;
